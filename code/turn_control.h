...
#define TURN_CONTROL_STOP_YAW_ANGLE_DEG        (83.0f)
...
#define TURN_CONTROL_ANGLE_PID_MAX_OUT         (3.5f)
#define TURN_CONTROL_ANGLE_PID_MAX_IOUT        (1.0f)
#define TURN_CONTROL_ANGLE_KP                  (0.012f)
