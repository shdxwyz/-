...
void ELRS_UARTE_RxCallback(uint16_t Size)
{
    ...
    if (elrs_data_temp[date_i+0] == CRSF_ADDRESS_FLIGHT_CONTROLLER)
    {
        ...
        else if (elrs_data_temp[date_i+2] == CRSF_FRAMETYPE_RC_CHANNELS_PACKED) // 数据帧类型为RC通道数据
        {
            ...
            elrs_data.Roll 		= int16_Map_with_median(elrs_data.channels[3], 174, 1808, 992, -80, 80);
			elrs_data.Throttle	= int16_Map_with_median(elrs_data.channels[2], 174, 1811, 992, 0, 1000);
            elrs_data.Yaw 		= int16_Map_with_median(elrs_data.channels[0], 174, 1811, 992, -400, 400);
